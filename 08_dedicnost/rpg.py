...
class Bojovnik(Postava):
    def __init__(self, jmeno, zivot, poskozeni):
        super().__init__(jmeno, zivot)
...
class Lucistnik(Bojovnik):
    def __init__(self, jmeno, zivot, poskozeni, pocet_sipu):
        super().__init__(jmeno, zivot, poskozeni)
...
class Sermir(Bojovnik):
    def __init__(self, jmeno, zivot, poskozeni, ucinnost_stitu):
        super().__init__(jmeno, zivot, poskozeni)
...
class Kouzelnik(Postava):
    def __init__(self, jmeno, zivot, uzdraveni):
        super().__init__(jmeno, zivot)
...
hodni = Armada("hodni", "modra")
zli = Armada("zli", "cervena")

p1 = Postava("Pepa", 100)
hodni.pridej_postavu(p1)
